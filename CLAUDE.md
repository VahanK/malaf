...
1. **Public page** at {domain}/{handle}: services, portfolio blocks (per §0), prices optional, request-a-quote button, save-contact vCard, WhatsApp button. Page footer invites viewers to create their own (viral loop).
