...
- **Replacement viral/growth loop** (vahan, Jul 20): the "make your free card" footer was removed from public pages (CLAUDE.md §1) because it undercut paying freelancers' pages. That was the named growth mechanic — nothing replaces it yet. Candidates to evaluate: word-of-mouth from the campus playbook, a referral incentive (e.g. discount for referring another freelancer), or the receipt/document footer instead of the live card page.
