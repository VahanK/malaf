...
// Fit: marketing homepage (volume). Blocked by no-fake-proof rule until real users.
...
const TESTIMONIAL_DATA = [
  { tempId: 0, testimonial: "My favorite solution in the market. We work 5x faster with COMPANY.", by: "Alex, CEO at COMPANY", imgSrc: "/imgs/head-shots/1.jpg" },
  { tempId: 1, testimonial: "I'm confident my data is safe with COMPANY.", by: "Dan, CEO at COMPANY", imgSrc: "/imgs/head-shots/2.jpg" },
  { tempId: 2, testimonial: "We were lost before we found COMPANY.", by: "Stephanie, CEO at COMPANY", imgSrc: "/imgs/head-shots/3.jpg" },
  { tempId: 3, testimonial: "COMPANY makes planning seamless.", by: "Marie, CEO at COMPANY", imgSrc: "/imgs/head-shots/4.jpg" },
  { tempId: 4, testimonial: "If I could give 11 stars, I'd give 12.", by: "Andre, CEO at COMPANY", imgSrc: "/imgs/head-shots/5.jpg" },
  { tempId: 5, testimonial: "SO HAPPY WE FOUND YOU GUYS!", by: "Jeremy, CEO at COMPANY", imgSrc: "/imgs/head-shots/6.jpg" },
];
